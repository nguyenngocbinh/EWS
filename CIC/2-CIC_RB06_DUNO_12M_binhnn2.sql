...
DROP TABLE IF EXISTS tmp_CIC_RB06_DUNO_12M;
CREATE TABLE tmp_CIC_RB06_DUNO_12M AS (
WITH uniq_all as(
SELECT
	DISTINCT 
...
SELECT *
    ...
    ,LEAD(TONGDUNO,  1) OVER (PARTITION BY MA_CIC, DATE_MSP ORDER BY THANG DESC) AS TONGDUNO_L1M
    ,LEAD(TONGDUNO,  2) OVER (PARTITION BY MA_CIC, DATE_MSP ORDER BY THANG DESC) AS TONGDUNO_L3M
    ,LEAD(TONGDUNO,  5) OVER (PARTITION BY MA_CIC, DATE_MSP ORDER BY THANG DESC) AS TONGDUNO_L6M
    ,LEAD(TONGDUNO, 11) OVER (PARTITION BY MA_CIC, DATE_MSP ORDER BY THANG DESC) AS TONGDUNO_L12M
    ,LEAD(DUNOVAY,   1) OVER (PARTITION BY MA_CIC, DATE_MSP ORDER BY THANG DESC) AS DUNOVAY_L1M
    ,LEAD(DUNOVAY,   2) OVER (PARTITION BY MA_CIC, DATE_MSP ORDER BY THANG DESC) AS DUNOVAY_L3M
    ,LEAD(DUNOVAY,   5) OVER (PARTITION BY MA_CIC, DATE_MSP ORDER BY THANG DESC) AS DUNOVAY_L6M
    ,LEAD(DUNOVAY,  11) OVER (PARTITION BY MA_CIC, DATE_MSP ORDER BY THANG DESC) AS DUNOVAY_L12M
    ,LEAD(DUNOTHE,   1) OVER (PARTITION BY MA_CIC, DATE_MSP ORDER BY THANG DESC) AS DUNOTHE_L1M
    ,LEAD(DUNOTHE,   2) OVER (PARTITION BY MA_CIC, DATE_MSP ORDER BY THANG DESC) AS DUNOTHE_L3M
    ,LEAD(DUNOTHE,   5) OVER (PARTITION BY MA_CIC, DATE_MSP ORDER BY THANG DESC) AS DUNOTHE_L6M
    ,LEAD(DUNOTHE,  11) OVER (PARTITION BY MA_CIC, DATE_MSP ORDER BY THANG DESC) AS DUNOTHE_L12M 
    ,SUM(TONGDUNO) OVER (PARTITION BY MA_CIC, DATE_MSP ORDER BY THANG ROWS BETWEEN 2 PRECEDING AND CURRENT ROW) AS SUM_TONGDUNO_L3M
    ,SUM(TONGDUNO) OVER (PARTITION BY MA_CIC, DATE_MSP ORDER BY THANG ROWS BETWEEN 5 PRECEDING AND CURRENT ROW) AS SUM_TONGDUNO_L6M
    ,SUM(TONGDUNO) OVER (PARTITION BY MA_CIC, DATE_MSP ORDER BY THANG ROWS BETWEEN 11 PRECEDING AND CURRENT ROW) AS SUM_TONGDUNO_L12M
    ,SUM(DUNOVAY) OVER (PARTITION BY MA_CIC, DATE_MSP ORDER BY THANG ROWS BETWEEN 2 PRECEDING AND CURRENT ROW) AS SUM_DUNOVAY_L3M
    ,SUM(DUNOVAY) OVER (PARTITION BY MA_CIC, DATE_MSP ORDER BY THANG ROWS BETWEEN 5 PRECEDING AND CURRENT ROW) AS SUM_DUNOVAY_L6M
    ,SUM(DUNOVAY) OVER (PARTITION BY MA_CIC, DATE_MSP ORDER BY THANG ROWS BETWEEN 11 PRECEDING AND CURRENT ROW) AS SUM_DUNOVAY_L12M
    ,SUM(DUNOTHE) OVER (PARTITION BY MA_CIC, DATE_MSP ORDER BY THANG ROWS BETWEEN 2 PRECEDING AND CURRENT ROW) AS SUM_DUNOTHE_L3M
    ,SUM(DUNOTHE) OVER (PARTITION BY MA_CIC, DATE_MSP ORDER BY THANG ROWS BETWEEN 5 PRECEDING AND CURRENT ROW) AS SUM_DUNOTHE_L6M
    ,SUM(DUNOTHE) OVER (PARTITION BY MA_CIC, DATE_MSP ORDER BY THANG ROWS BETWEEN 11 PRECEDING AND CURRENT ROW) AS SUM_DUNOTHE_L12M
    ,MIN(TONGDUNO) OVER (PARTITION BY MA_CIC, DATE_MSP ORDER BY THANG ROWS BETWEEN 2 PRECEDING AND CURRENT ROW) AS MIN_TONGDUNO_L3M
    ,MIN(TONGDUNO) OVER (PARTITION BY MA_CIC, DATE_MSP ORDER BY THANG ROWS BETWEEN 5 PRECEDING AND CURRENT ROW) AS MIN_TONGDUNO_L6M
    ,MIN(TONGDUNO) OVER (PARTITION BY MA_CIC, DATE_MSP ORDER BY THANG ROWS BETWEEN 11 PRECEDING AND CURRENT ROW) AS MIN_TONGDUNO_L12M
    ,MIN(DUNOVAY) OVER (PARTITION BY MA_CIC, DATE_MSP ORDER BY THANG ROWS BETWEEN 2 PRECEDING AND CURRENT ROW) AS MIN_DUNOVAY_L3M
    ,MIN(DUNOVAY) OVER (PARTITION BY MA_CIC, DATE_MSP ORDER BY THANG ROWS BETWEEN 5 PRECEDING AND CURRENT ROW) AS MIN_DUNOVAY_L6M
    ,MIN(DUNOVAY) OVER (PARTITION BY MA_CIC, DATE_MSP ORDER BY THANG ROWS BETWEEN 11 PRECEDING AND CURRENT ROW) AS MIN_DUNOVAY_L12M
    ...
    ,MAX(TONGDUNO) OVER (PARTITION BY MA_CIC, DATE_MSP ORDER BY THANG ROWS BETWEEN 2 PRECEDING AND CURRENT ROW) AS MAX_TONGDUNO_L3M
    ,MAX(TONGDUNO) OVER (PARTITION BY MA_CIC, DATE_MSP ORDER BY THANG ROWS BETWEEN 5 PRECEDING AND CURRENT ROW) AS MAX_TONGDUNO_L6M
    ,MAX(TONGDUNO) OVER (PARTITION BY MA_CIC, DATE_MSP ORDER BY THANG ROWS BETWEEN 11 PRECEDING AND CURRENT ROW) AS MAX_TONGDUNO_L12M
    ,MAX(DUNOVAY) OVER (PARTITION BY MA_CIC, DATE_MSP ORDER BY THANG ROWS BETWEEN 2 PRECEDING AND CURRENT ROW) AS MAX_DUNOVAY_L3M
    ,MAX(DUNOVAY) OVER (PARTITION BY MA_CIC, DATE_MSP ORDER BY THANG ROWS BETWEEN 5 PRECEDING AND CURRENT ROW) AS MAX_DUNOVAY_L6M
    ,MAX(DUNOVAY) OVER (PARTITION BY MA_CIC, DATE_MSP ORDER BY THANG ROWS BETWEEN 11 PRECEDING AND CURRENT ROW) AS MAX_DUNOVAY_L12M
    ...
    ,AVG(TONGDUNO) OVER (PARTITION BY MA_CIC, DATE_MSP ORDER BY THANG ROWS BETWEEN 2 PRECEDING AND CURRENT ROW) AS AVG_TONGDUNO_L3M
    ,AVG(TONGDUNO) OVER (PARTITION BY MA_CIC, DATE_MSP ORDER BY THANG ROWS BETWEEN 5 PRECEDING AND CURRENT ROW) AS AVG_TONGDUNO_L6M
    ,AVG(TONGDUNO) OVER (PARTITION BY MA_CIC, DATE_MSP ORDER BY THANG ROWS BETWEEN 11 PRECEDING AND CURRENT ROW) AS AVG_TONGDUNO_L12M
    ,AVG(DUNOVAY) OVER (PARTITION BY MA_CIC, DATE_MSP ORDER BY THANG ROWS BETWEEN 2 PRECEDING AND CURRENT ROW) AS AVG_DUNOVAY_L3M
    ,AVG(DUNOVAY) OVER (PARTITION BY MA_CIC, DATE_MSP ORDER BY THANG ROWS BETWEEN 5 PRECEDING AND CURRENT ROW) AS AVG_DUNOVAY_L6M
    ,AVG(DUNOVAY) OVER (PARTITION BY MA_CIC, DATE_MSP ORDER BY THANG ROWS BETWEEN 11 PRECEDING AND CURRENT ROW) AS AVG_DUNOVAY_L12M
...
-------------------------------------------------------------
DROP TABLE IF EXISTS tmp_rn1;
CREATE TABLE tmp_rn1 AS
-- INSERT INTO tmp_rn1
(SELECT
    DATE_MSP,
    MA_CIC,
...
FROM tmp_CIC_RB06_DUNO_12M
WHERE rn = 12
AND DATE_MSP IS NOT NULL 
...
ALTER TABLE tmp_rn1
ALTER COLUMN DATE_MSP SET NOT NULL;
ALTER TABLE tmp_rn1
ALTER COLUMN MA_CIC SET NOT NULL;
ALTER TABLE tmp_rn1
ADD PRIMARY KEY (DATE_MSP, MA_CIC);

DROP TABLE IF EXISTS tmp_grp12;

CREATE TABLE tmp_grp12 AS (
SELECT
        DATE_MSP
        ,MA_CIC
